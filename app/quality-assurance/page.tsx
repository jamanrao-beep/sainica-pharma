      ...
      <section className="section-tight">
        <div className="container split">
          ...
          <div className="split-media frame">
            ...
            <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Sainica Healthcare quality control lab" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
        </div>
      </section>
