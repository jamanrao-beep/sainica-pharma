      ...
      <section className="section-tight">
        <div className="container split">
          ...
          <div className="split-media frame">
            ...
            <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Sainica Healthcare doctors stethoscope" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
        </div>
      </section>
